...
function Instructions({ handleHowToPlayClick }) {
  return (
    <div className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur">
      <div className="absolute text-black top-1/3 left-1/2 transform -translate-x-1/2 translate-y-1/2 rounded-lg text-lg text-background font-color bg-white border-4 text-center jost px-6 md:px-4 lg:px-2">
